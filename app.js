...
const produtos = [
    {id:1, nome:'Mouse', preco: 80, estoque: 100, categoria:'Periféricos'},
    {id:2, nome:'Monitor', preco: 900, estoque: 50, categoria:'Video'},
    {id:3, nome:'Teclado', preco: 120, estoque: 200, categoria:'Periféricos'}
];
...
async function executar() {
    ...
    try {
        ...
        const [produto, categorias] = await Promise.all([buscaProdutoPorId(id), listarCategorias()]);
